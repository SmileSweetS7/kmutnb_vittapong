...
public class Title extends JPanel implements MouseListener, MouseMotionListener{
	...
	public Title(Window window){
		try {
			title = ImageIO.read(Board.class.getResource("/124537737_1231232987263324_4577694112175396678_n.png"));
		...
		bounds = new Rectangle(Window.WIDTH/2 -45, Window.HEIGHT/2 - 80, 100, 80);
		this.window = window;
