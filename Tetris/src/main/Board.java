...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener{
	...
	public Board(){
		...
		background = ImageLoader.loadImage("/3311924db62ceef62a4a7ee87017280f.jpg");
	...
	public void paintComponent(Graphics g){
		...
		if(stopBounds.contains(mouseX, mouseY))
			g.drawImage(pause.getScaledInstance(pause.getWidth() + 3, pause.getHeight() + 3, BufferedImage.SCALE_DEFAULT)
					, stopBounds.x + 3, stopBounds.y , null);
		else
		...
		g.drawString(""+level, Window.WIDTH - 125, Window.HEIGHT/2+90);
		g.drawString(""+score, Window.WIDTH - 125, Window.HEIGHT/2 + 30);
	...
	public void setNextShape(){
		...
		if(score>10)
		{
			level = 1;
			Random = 7;
			currentShape.setNormal(500);
		}
		if(score>30)
		{
			level = 2;
			Random = 7;
			currentShape.setNormal(400);
		}
		if(score>50)
		{
			level = 3;
			Random = 7;
			currentShape.setNormal(300);
		}
